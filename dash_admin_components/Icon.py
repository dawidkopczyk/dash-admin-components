...
- border (boolean; default False): FontAwesome setting: border. Default: False.
- className (string; default ''): FontAwesome setting: additional class.
- mask (dict | list | string; optional): FontAwesome setting: mask.
- fixedWidth (boolean; default False): FontAwesome setting: fixed witdh. Default: False.
- inverse (boolean; default False): FontAwesome setting: inverse. Default: False.
...
- listItem (boolean; default False): FontAwesome setting: list item. Default: False.
- pull (a value equal to: 'right', 'left'; optional): FontAwesome setting: pull. Options: right, left.
- pulse (boolean; default False): FontAwesome setting: pulse. Default: False.
...
- spin (boolean; default False): FontAwesome setting: spin. Default: False.
- symbol (boolean | string; default False): FontAwesome setting: symbol. Default: False.
- title (string; default ''): FontAwesome setting: title.
