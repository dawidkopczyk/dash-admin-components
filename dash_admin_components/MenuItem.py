...
- text (string; optional): Menu item name.
...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, text=Component.UNDEFINED, active=Component.UNDEFINED, disabled=Component.UNDEFINED, icon=Component.UNDEFINED, start_expanded=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'text', 'active', 'disabled', 'icon', 'start_expanded', 'n_clicks', 'n_clicks_timestamp', 'loading_state']
        self._type = 'MenuItem'
        self._namespace = 'dash_admin_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'text', 'active', 'disabled', 'icon', 'start_expanded', 'n_clicks', 'n_clicks_timestamp', 'loading_state']
