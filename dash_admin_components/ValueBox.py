...
Those keys have the following types:
  ...
  - component_name (string; optional): Holds the name of the component that is loading"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, style=Component.UNDEFINED, width=Component.UNDEFINED, status=Component.UNDEFINED, icon=Component.UNDEFINED, subtitle=Component.UNDEFINED, value=Component.UNDEFINED, href=Component.UNDEFINED, footer_text=Component.UNDEFINED, elevation=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'style', 'width', 'status', 'icon', 'subtitle', 'value', 'href', 'footer_text', 'elevation', 'loading_state']
        self._type = 'ValueBox'
        self._namespace = 'dash_admin_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'style', 'width', 'status', 'icon', 'subtitle', 'value', 'href', 'footer_text', 'elevation', 'loading_state']
