...
- width (number; default 3): The width of the box, using the Bootstrap grid system. This is
...
Default: NULL.
- icon (string; default 'user'): An icon tag. Default: user.
- subtitle (string; optional): Subtitle text.
- href (string; optional): An optional URL to link to.
- footer_text (string; default 'See more '): Text displayed in footer.
