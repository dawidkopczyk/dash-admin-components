...
/**
 * Create a Boostrap 4 tab box header.
 */
export default class TabBoxHeader extends Component {
	...
	render() {
		...
		return (
			...
			>
				{children}
				<h3 className="card-title p-3 ml-auto">
					{title}
				</h3>
				<div className="tools pt-3 pr-2 mr-2">
					{CollapseButton}
					{CloseButton}
				</div>
			</div>
